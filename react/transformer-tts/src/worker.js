import {
    ...
    SpeechT5HifiGan // 语音合成模型，以及音色合成
} from '@xenova/transformers';
// huggingFace 开源的大模型社区
// 禁用本地大模型，去请求远程的tts大模型
env.allowLocalModels = false;

// transformer.js 文本 -> 语音tts
// 单例模式 核心难点
// 多次执行tts ai 业务，但是只会实例化一次
// 它的实例化开销太大了，所以只能单例模式
class MyTextToSpeechPipeline {
    // AI 语音模型的数据源地址，用于下载不用说话人的声音特征向量
    // 每个字，每个词
    ...
    static vacoder_id = 'Xenova/speecht5_hifigan'
    // 分词器实例
